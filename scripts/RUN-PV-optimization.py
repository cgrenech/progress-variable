...
if scaling == 'none':
    ...
    (Yi_CS, centers, scales) = preprocess.center_scale(state_space[:,5::], scaling=scaling)
...
print("state_space_sources shape:", state_space_sources.shape)

print("Yi_CS shape:", Yi_CS.shape)
print("Yi_sources_CS shape:", Yi_sources_CS.shape)

print("scales shape:", scales.shape if scaling != 'none' else "not used")

n_species = Yi_CS.shape[1]
n_variables = n_species + 1
